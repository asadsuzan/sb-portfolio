...
const HeaderRight = React.forwardRef(function HeaderRight({ isOpen }, ref) {
  return (
    <div
      ref={ref}
      className={`${
            ...
            <Link
              ...
              className={`${
                pathName === item.path
                  ...
                  : 'text-[#dedee0]'
              } font-bold text-[11px] tracking-[2px] xl:leading-[80px] px-[20px] h-full w-full uppercase relative hover:text-[#6fb965] transition-colors duration-500`}
            >
              {item.name}
            </Link>
          </li>
    ...
    <div className="w-full h-full flex justify-center items-center xl:ml-[50px]">
      ...
      >
        <div
          ...
          } h-[20px] w-[20px] rounded-[50%] border-[3px] transition-transform duration-500 border-[#70ba65]`}
        ></div>
      </div>
